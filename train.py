...
from graph_feature.dataset import Dataset
import os
import argparse
...
def main():
    ...
    # BioSNAP dataset
    train_data = pd.read_csv('dataset/train_biosnap_smiles_new.csv')
    test_data = pd.read_csv('dataset/test_biosnap_smiles_new.csv')
    training_set = Dataset(train_data.index.values, train_data.label.values, train_data)
    training_generator = data.DataLoader(training_set, **params)
    testing_set = validation_set = Dataset(test_data.index.values, test_data.label.values, test_data)
    testing_generator = validation_generator = data.DataLoader(validation_set, **params)
    ...
    # train_data = pd.read_csv('dataset/AdverseDDI_train.csv')
    # val_data = pd.read_csv('dataset/AdverseDDI_valid.csv')
    # test_data = pd.read_csv('dataset/AdverseDDI_test.csv')
